...
INSERT INTO public.service_tariffs (
  ...
  (
    'tire_change',
    'Cambio de llanta',
    'Cambio de llanta cuando el usuario tiene llanta de emergencia/repuesto disponible.',
    'fixed',
    20.00,
    NULL,
    NULL,
    ...
    false,
    NULL,
    'Incluye cambio de llanta usando el repuesto disponible del usuario.',
    'No incluye compra de llanta, reparacion de aro, valvula ni grua.',
    false,
    true,
    10
  ),
  (
    ...
    'Asistencia inicial cuando el usuario no tiene repuesto o no se conoce si tiene repuesto.',
    'diagnostic',
    12.00,
    NULL,
    NULL,
    ...
    false,
    NULL,
    'Incluye revision inicial de la rueda afectada y recomendacion del siguiente paso.',
    'Puede requerir vulcanizadora, parche, valvula, inflado temporal o grua con aprobacion previa.',
    true,
    true,
    20
  ),
